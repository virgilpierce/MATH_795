...
- Requires lots of features if they are categorical (we should pivot long)
...
Let's actually pivot long today and turn our dataframe into one with a feature for each value of the factor variables.
